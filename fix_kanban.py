...
# Revert to the state before my changes
os.system('git checkout HEAD~2 -- frontend/src/components/clinic/ClinicKanban.jsx')
...
# ONLY REPLACE AT THE VERY END OF THE FILE
end_idx = content.rfind('</Box>\n  );\n}')
if end_idx != -1:
    content = content[:end_idx] + modal_ui + content[end_idx:]
