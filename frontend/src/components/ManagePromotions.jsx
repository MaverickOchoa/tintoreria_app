              ...
              {Object.entries(TRIGGER_META).map(([trigger, meta]) => {
                ...
                return (
                  <Paper key={trigger} elevation={2} sx={{ p: 3, borderRadius: 3 }}>
                    ...
                    {/* Channel selector */}
                    <Box mt={1.5} mb={1}>
                      <Typography variant="caption" fontWeight={700} color="text.secondary" display="block" mb={0.5}>CANAL DE ENVÃO</Typography>
