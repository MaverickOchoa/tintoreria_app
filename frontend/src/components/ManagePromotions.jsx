                    ...
                    <Box display="flex" justifyContent="space-between" alignItems="flex-start">
                      <Box flex={1}>
                        <Box display="flex" alignItems="center" gap={1} mb={0.5} flexWrap="wrap">
                          ...
                          {c.fired_at && <Chip size="small" label="✓ Enviada" color="success" />}
                        </Box>
